...
import { Invoice , TableForm} from './InvoiceForm'; 
...
const InvoiceDisplay: React.FC<InvoiceDisplayProps> = ({ invoiceDetails, items, onClose }) => {
        ...
        <Scroll>
            ...
            <Main>
                <div className = 'quote'>
                    <div className='left'>
                        <h2>BILL TO:  </h2>
                        <div>Dear {invoiceDetails.clientName}</div>
                        <br />
                        <div> Services: 
                    ...
                    <div className="right">
                        <div>Date : {invoiceDetails.invoiceDate}</div><br />
                        <div>Quote No. : {invoiceDetails.invoiceNo}</div>
                    </div>
                </div>
                <div>
                    <h2>FROM</h2>
            ...
            <div>{invoiceDetails.termsAndCondition}</div>
            </Component>
        </Scroll>
      </Modal>
    </Overlay>
